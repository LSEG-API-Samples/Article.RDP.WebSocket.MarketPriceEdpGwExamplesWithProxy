...
namespace MarketPriceEdpGwAuthenticationWithProxyExample
{
    class MarketPriceEdpGwAuthenticationWithProxyExample
    {
        ...
        {
            MarketPriceEdpGwAuthenticationWithProxyExample example = new MarketPriceEdpGwAuthenticationWithProxyExample();
        ...
        {
            Console.WriteLine("Usage: {0} [--app_id appId] [--auth_hostname hostname] [--auth_port port] [--hostname hostname] [--password password] [--port port] [--ric ric] [--scope scope] [--user user]  [--proxy_hostname proxy_hostname] [--proxy_port proxy_port]", System.AppDomain.CurrentDomain.FriendlyName);
            Environment.Exit(1);
        }
    }
}
