...
namespace MarketPriceEdpGwServiceDiscoveryWithProxyExample
{
    class MarketPriceEdpGwServiceDiscoveryWithProxyExample
    {
        ...
        private static string _proxyPort = "8888";
        ...
        {
            MarketPriceEdpGwServiceDiscoveryWithProxyExample example = new MarketPriceEdpGwServiceDiscoveryWithProxyExample();
        ...
        {
            Console.WriteLine("Usage: {0} [--app_id appID] [--auth_hostname hostname] [--auth_port port] [--hotstandby] [--password password] [--region region] [--ric ric] [--scope scope] [--user user] [--proxy_hostname proxy_hostname] [--proxy_port proxy_port]", System.AppDomain.CurrentDomain.FriendlyName);
            Environment.Exit(1);
        }
    }
}
