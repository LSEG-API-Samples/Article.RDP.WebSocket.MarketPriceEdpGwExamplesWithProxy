...
namespace MarketPriceEdpGwServiceDiscoveryExample
{
    ...
    class MarketPriceEdpGwServiceDiscoveryExample
    {
        ...
        {
            Console.WriteLine("Usage: {0} [--app_id appID] [--auth_url auth_url] [--discovery_url discovery_url] [--hotstandby] [--password password] [--newPassword new_password] [--region region] [--ric ric] [--scope scope] [--user user] [--clientid clientID] [--service service] [--proxy_hostname proxy_hostname] [--proxy_port proxy_port]", System.AppDomain.CurrentDomain.FriendlyName);
            Environment.Exit(1);
        }
